...
import net.astormofsorts.agotmod.armor.client.manderly.ManderlyLevyArmorRenderer;
import net.astormofsorts.agotmod.armor.client.stark.StarkLevyArmorRenderer;
...
public class ManderlyLevyArmorItem extends ArmorItem implements GeoItem {
    // Instance of AnimatableInstanceCache to manage animations
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    // Constructor for Stark1ArmorItem
    public ManderlyLevyArmorItem(ModArmorMaterials modArmorMaterials, Type type, Properties properties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                ...
                if (this.renderer == null)
                    this.renderer = new ManderlyLevyArmorRenderer();
