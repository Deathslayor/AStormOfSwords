...
public class MammothModel extends EntityModel<MammothRenderState> {
    ...
    public MammothModel(ModelPart root) {
        ...
        ModelPart mammoth = root.getChild("mammoth");
    ...
    public void setupAnim(@NotNull MammothRenderState state) {
        ...
        this.animate(state.idleAnimationState, ModAnimationDefinitions.MAMMOTH_IDLE, state.ageInTicks, 1f);

        // Animate the attack state using the Mammoth_ATTACK animation definition
        this.animate(state.attackAnimationState, ModAnimationDefinitions.MAMMOTH_ATTACK, state.ageInTicks, 1f);
    }
