package net.darkflameproduction.agotmod.entity.client;// Made with Blockbench 4.8.3
...
public class BearModel<T extends EntityRenderState> extends EntityModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(AGoTMod.id("bear"), "main");

    public BearModel(ModelPart root) {
        super(root.getChild("bear"));
    }
