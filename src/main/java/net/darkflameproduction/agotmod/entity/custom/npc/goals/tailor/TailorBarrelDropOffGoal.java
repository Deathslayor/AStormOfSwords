...
public class TailorBarrelDropOffGoal extends Goal {
    ...
    static {
        ...
        DEPOSIT_ITEMS.add("minecraft:white_wool");
        DEPOSIT_ITEMS.add("agotmod:cloth");
        DEPOSIT_ITEMS.add("agotmod:fur");
        DEPOSIT_ITEMS.add("minecraft:leather_helmet");
        DEPOSIT_ITEMS.add("minecraft:leather_chestplate");
        DEPOSIT_ITEMS.add("minecraft:leather_leggings");
        DEPOSIT_ITEMS.add("minecraft:leather_boots");
        DEPOSIT_ITEMS.add("minecraft:white_dye");
        DEPOSIT_ITEMS.add("minecraft:orange_dye");
        DEPOSIT_ITEMS.add("minecraft:magenta_dye");
        DEPOSIT_ITEMS.add("minecraft:light_blue_dye");
        DEPOSIT_ITEMS.add("minecraft:yellow_dye");
        DEPOSIT_ITEMS.add("minecraft:lime_dye");
        DEPOSIT_ITEMS.add("minecraft:pink_dye");
        DEPOSIT_ITEMS.add("minecraft:gray_dye");
        DEPOSIT_ITEMS.add("minecraft:light_gray_dye");
        DEPOSIT_ITEMS.add("minecraft:cyan_dye");
        DEPOSIT_ITEMS.add("minecraft:purple_dye");
        DEPOSIT_ITEMS.add("minecraft:blue_dye");
        DEPOSIT_ITEMS.add("minecraft:brown_dye");
        DEPOSIT_ITEMS.add("minecraft:green_dye");
        DEPOSIT_ITEMS.add("minecraft:red_dye");
        DEPOSIT_ITEMS.add("minecraft:black_dye");
    }

    public TailorBarrelDropOffGoal(Peasant_Entity peasant) {
    ...
    public boolean canUse() {
        ...
        if (dayTime >= 12000 && dayTime <= 13000
            ...
            if (!barrelState.is(ModBLocks.TAILOR_BARREL.get())) return false;
    ...
    private void consumeConfirmationAndClearInventory() {
        ...
        peasant.getTailorSystem().setCurrentState(TailorSystem.TailorState.GOING_TO_JOB_BLOCK);
    }
