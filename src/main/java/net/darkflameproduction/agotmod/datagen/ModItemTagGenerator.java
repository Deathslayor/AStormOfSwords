...
// LEAVES tag
        ...
        this.tag(ItemTags.MEAT)
                ...
                .add(ModItems.RAW_VENISON.get().asItem())
                .add(ModItems.COOKED_VENISON.get().asItem())
                .add(ModItems.RAW_LAMB.get().asItem())
                .add(ModItems.COOKED_LAMB.get().asItem())
                .add(ModItems.RAW_PORK.get().asItem())
                .add(ModItems.COOKED_PORK.get().asItem())
                .add(ModItems.SUCKLING_PIG.get().asItem())
                ...
                .add(ModItems.DORMICE.get().asItem())
                .add(ModItems.SNAILS.get().asItem())
                .add(ModItems.LOCUSTS.get().asItem())
                .add(ModItems.HONEYED_LOCUSTS.get().asItem())
                .add(ModItems.STALLION_HEART.get().asItem())
                .add(ModItems.KIDNEYS.get().asItem())
                .add(ModItems.LIVER.get().asItem())
                .add(ModItems.GOOSE_LIVER.get().asItem())
                .add(ModItems.SWEETBREADS.get().asItem())
                .add(ModItems.JELLIED_CALVES_BRAINS.get().asItem())
                .add(ModItems.ROASTED_RIBS.get().asItem())
                .add(ModItems.PEPPERED_BOAR.get().asItem())
                .add(ModItems.ROAST_BOAR.get().asItem())
                .add(ModItems.BLACK_SAUSAGE.get().asItem())
                .add(ModItems.SALT_MUTTON.get().asItem())
                .add(ModItems.BOILED_MUTTON.get().asItem())
                .add(ModItems.MUTTON_CHOP.get().asItem())
                .add(ModItems.MUTTON_STEW.get().asItem())
                .add(ModItems.SPICED_MUTTON.get().asItem())
                .add(ModItems.SALT_BEEF.get().asItem())
                ...
                .add(ModItems.RAW_CAPON.get().asItem())
                .add(ModItems.COOKED_CAPON.get().asItem())
                ...
                .add(ModItems.CLAMS.get().asItem())
                .add(ModItems.MUSSELS.get().asItem())
                .add(ModItems.WINKLES.get().asItem())
