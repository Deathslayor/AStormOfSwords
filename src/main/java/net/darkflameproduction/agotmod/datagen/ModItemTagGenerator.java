...
// TRAPDOORS
        ...
        this.tag(ItemTags.WALLS)
                .add(ModBLocks.SSTONE_1_WALL.get().asItem())
                .add(ModBLocks.SSTONE_2_WALL.get().asItem())
                .add(ModBLocks.SSTONE_3_WALL.get().asItem())
        ;

        this.tag(ItemTags.STONE_BRICKS)
                .add(ModBLocks.SSTONE_1_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_1_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_1_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_1_WALL.get().asItem())
                .add(ModBLocks.SSTONE_2_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_2_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_2_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_2_WALL.get().asItem())
                .add(ModBLocks.SSTONE_3_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_3_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_3_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_3_WALL.get().asItem())
                .add(ModBLocks.SSTONE_4_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_4_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_4_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_4_WALL.get().asItem())
                .add(ModBLocks.SSTONE_5_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_5_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_5_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_5_WALL.get().asItem())
                .add(ModBLocks.SSTONE_6_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_6_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_6_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_6_WALL.get().asItem())
                .add(ModBLocks.SSTONE_7_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_7_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_7_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_7_WALL.get().asItem())
                .add(ModBLocks.SSTONE_8_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_8_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_8_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_8_WALL.get().asItem())
                .add(ModBLocks.SSTONE_9_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_9_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_9_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_9_WALL.get().asItem())
                .add(ModBLocks.SSTONE_10_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_10_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_10_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_10_WALL.get().asItem())
                .add(ModBLocks.SSTONE_11_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_11_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_11_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_11_WALL.get().asItem())
                .add(ModBLocks.SSTONE_12_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_12_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_12_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_12_WALL.get().asItem())
                .add(ModBLocks.SSTONE_13_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_13_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_13_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_13_WALL.get().asItem())
                .add(ModBLocks.SSTONE_14_BLOCK.get().asItem())
                .add(ModBLocks.SSTONE_14_STAIRS.get().asItem())
                .add(ModBLocks.SSTONE_14_SLAB.get().asItem())
                .add(ModBLocks.SSTONE_14_WALL.get().asItem())
