...
public class ModArmorSkinRenderer {
    ...
    Map.entry("wildling_tier1", () -> new Helmet(ModItems.WILDLING_FUR_HELMET.get())),
...
public static final Map<String, Supplier<Chestplate>> CHESTPLATES = Map.ofEntries(
    ...
    Map.entry("wildling_tier1", () -> new Chestplate(ModItems.WILDLING_FUR_CHESTPLATE.get())),
...
public static final Map<String, Supplier<Leggings>> LEGGINGS = Map.ofEntries(
    ...
    Map.entry("wildling_tier1", () -> new Leggings(ModItems.WILDLING_FUR_LEGGINGS.get())),
...
public static final Map<String, Supplier<Boots>> BOOTS = Map.ofEntries(
    ...
    Map.entry("wildling_tier1", () -> new Boots(ModItems.WILDLING_FUR_BOOTS.get())),
