...
public class ModNetworking {
    ...
    public static void register(final RegisterPayloadHandlersEvent event) {
        ...
        // Register open NPC conversation packet (server -> client)
        registrar.playToClient(
...
// Register close NPC conversation packet (client -> server)
        registrar.playToServer(
...
// Register open NPC inventory packet (client -> server)
        registrar.playToServer(
...
// Register open NPC trade packet (client -> server)
        registrar.playToServer(
