...
public class WildlingLeatherArmorModel extends GeoModel<WildlingLeatherArmorItem> {
    @Override
    public ResourceLocation getModelResource(WildlingLeatherArmorItem animatable) {
        // Return the resource location for the model
        return AGoTMod.id("geo/wildling_leather.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(WildlingLeatherArmorItem animatable) {
