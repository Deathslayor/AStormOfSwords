package net.darkflameproduction.agotmod.custom;
...
public enum ModArmorMaterials implements ArmorMaterial {STARK1("stark1", 500,Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
