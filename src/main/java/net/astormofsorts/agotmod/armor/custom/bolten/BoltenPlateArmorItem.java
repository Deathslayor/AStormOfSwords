...
import net.astormofsorts.agotmod.armor.client.bolten.BoltenPlateArmorRenderer;
...
public class BoltenPlateArmorItem extends ArmorItem implements GeoItem {
    ...
    public BoltenPlateArmorItem(ModArmorMaterials modArmorMaterials, Type type, Properties properties) {
