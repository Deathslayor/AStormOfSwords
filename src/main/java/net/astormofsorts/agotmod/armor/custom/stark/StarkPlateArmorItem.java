...
public class StarkPlateArmorItem extends ArmorItem implements GeoItem {
    // Instance of AnimatableInstanceCache to manage animations
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    // Constructor for Stark1ArmorItem
    public StarkPlateArmorItem(ModArmorMaterials modArmorMaterials, Type type, Properties properties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                ...
                if (this.renderer == null)
                    this.renderer = new StarkPlateArmorRenderer();
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<GeoAnimatable>(this, 20, state -> {
            ...
            boolean isFullSet = wornArmor.containsAll(ObjectArrayList.of(
                    ModItems.STARKPLATE_HELMET.get(),
                    ModItems.STARKPLATE_CHESTPLATE.get(),
                    ModItems.STARKPLATE_LEGGINGS.get(),
                    ModItems.STARKPLATE_BOOTS.get()));
