...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_SYCAMORE_WOOD.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/sycamore_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_SENTINEL_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/sentinel_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_PINE_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/pine_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_IRONWOOD_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/ironwood_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_HAWTHORN_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/hawthorn_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_CHESTNUT_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/chestnut_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_CEDAR_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/cedar_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_BEECH_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/beech_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_ASH_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/ash_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_BLACKBARK_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/blackbark_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_ASPEN_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/aspen_log_top_stripped")); // top of the block
        ...
        axisBlock(((RotatedPillarBlock) ModBLocks.STRIPPED_ALDER_LOG.get()),
                ...
                new ResourceLocation(AGoTMod.MOD_ID, "block/alder_log_top_stripped")); // top of the block
