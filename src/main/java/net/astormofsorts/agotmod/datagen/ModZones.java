...
import dev.tocraft.crafted.ctgen.zone.ZoneBuilder;
...
public class ModZones {
    ...
    public static void bootstrap(BootstapContext<Zone> context) {
        // The North
        context.register(MANGOVES, new ZoneBuilder().setBiome(getBiome(context, Biomes.MANGROVE_SWAMP)).setColor(new Color(34, 51, 34)).setHeight(-3).setPerlinMultiplier(4).build());
        context.register(TAIGA, new ZoneBuilder().setBiome(getBiome(context, Biomes.TAIGA)).setColor(new Color(43, 70, 43)).setHeight(3).setPerlinMultiplier(6).build());
        ...
        context.register(FOREST, new ZoneBuilder().setBiome(getBiome(context, Biomes.FOREST)).setColor(new Color(61, 81, 51)).setHeight(3).setPerlinMultiplier(7).build());
        ...
        context.register(OLD_GROWTH_SPRUCE_TAIGA, new ZoneBuilder().setBiome(getBiome(context, Biomes.OLD_GROWTH_SPRUCE_TAIGA)).setColor(new Color(38, 59, 38)).setHeight(3).setPerlinMultiplier(6).build());
        // wall
        context.register(THE_WALL, new ZoneBuilder().setBiome(getBiome(context, Biomes.FROZEN_PEAKS)).setColor(new Color(255, 255, 255)).setStoneBlock(Blocks.PACKED_ICE).setDirtBlock(Blocks.PACKED_ICE).setSurfaceBlock(Blocks.SNOW_BLOCK).setHeight(213).setPerlinMultiplier(0).setPixelWeight(16).build());
        //North Of The Wall
    ...
    private static ResourceKey<Zone> getKey(String name) {
        return ResourceKey.create(CTerrainGeneration.MAP_ZONES_REGISTRY, new ResourceLocation(AGoTMod.MOD_ID, name));
    }
}
