...
public class ModZones {
    ...
    public static void bootstrap(BootstrapContext<Zone> context) {
        ...
        context.register(THE_NECK_RIVER, new ZoneBuilder().setBiome(getBiome(context, ModBiomes.THE_NECK)).setColor(new Color(87, 76, 47)).setDirtBlock(Blocks.MUD).setSurfaceBlock(Blocks.MUD).setHeight(-15).setPixelWeight(40).setCarverModifier(26).build());
        ...
        context.register(WOLFSWOOD_CLEARING, new ZoneBuilder().setBiome(getBiome(context, ModBiomes.WOLFSWOOD_CLEARING)).setColor(new Color(72, 122, 72)).setSurfaceBlock(Blocks.PODZOL).setHeight(3).setTerrainModifier(6).build());
        context.register(IRONWOOD, new ZoneBuilder().setBiome(getBiome(context, ModBiomes.IRONWOOD)).setColor(new Color(38, 59, 38)).setSurfaceBlock(Blocks.PODZOL).setHeight(3).setTerrainModifier(6).build());
        context.register(WOLFSWOOD, new ZoneBuilder().setBiome(getBiome(context, ModBiomes.WOLFSWOOD)).setColor(new Color(43, 70, 43)).setSurfaceBlock(Blocks.PODZOL).setHeight(3).setTerrainModifier(6).build());
        ...
        context.register(THE_NORTH, new ZoneBuilder().setBiome(getBiome(context, ModBiomes.THE_NORTH)).setColor(new Color(57, 95, 57)).setHeight(8).setTerrainModifier(3).build());
        context.register(RILLS, new ZoneBuilder().setBiome(getBiome(context, ModBiomes.RILLS)).setColor(new Color(61, 81, 51)).setSurfaceBlock(Blocks.MUD).setHeight(1).setTerrainModifier(12).build());
        ...
        context.register(NORTHERN_RIVER, new ZoneBuilder().setBiome(getBiome(context, ModBiomes.NORTHERN_WATERS)).setColor(new Color(1, 98, 255)).setDirtBlock(Blocks.MUD).setSurfaceBlock(Blocks.MUD).setHeight(-15).setPixelWeight(40).setCarverModifier(26).build());
        // wall
        ...
        //North Of The Wall
        context.register(HAUNTED_FOREST, new ZoneBuilder().setBiome(getBiome(context, ModBiomes.HAUNTED_FOREST)).setColor(new Color(130, 140, 130)).setSurfaceBlock(Blocks.PODZOL).setHeight(5).build());
