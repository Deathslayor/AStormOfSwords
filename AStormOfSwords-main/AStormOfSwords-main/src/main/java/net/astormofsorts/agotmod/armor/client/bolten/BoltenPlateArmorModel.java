...
public class BoltenPlateArmorModel extends GeoModel<BoltenPlateArmorItem> {
    ...
    @Override
    public ResourceLocation getModelResource(BoltenPlateArmorItem object) {
        // Return the resource location for the model
        return new ResourceLocation(AGoTMod.MOD_ID, "geo/bolten_plate.geo.json");
    }

    // Override method to get the texture resource location
    @Override
    public ResourceLocation getTextureResource(BoltenPlateArmorItem object) {
        // Return the resource location for the texture
        return new ResourceLocation(AGoTMod.MOD_ID, "textures/item/armor/bolten_plate.png");
    }
