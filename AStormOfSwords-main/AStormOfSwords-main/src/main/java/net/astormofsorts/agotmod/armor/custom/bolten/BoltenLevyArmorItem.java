...
import net.astormofsorts.agotmod.armor.client.bolten.BoltenLevyArmorRenderer;
...
public class BoltenLevyArmorItem extends ArmorItem implements GeoItem {
    ...
    public BoltenLevyArmorItem(ModArmorMaterials modArmorMaterials, Type type, Properties properties) {
