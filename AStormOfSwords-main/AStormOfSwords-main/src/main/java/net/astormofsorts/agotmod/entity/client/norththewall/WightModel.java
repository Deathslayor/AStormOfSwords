package net.astormofsorts.agotmod.entity.client.norththewall;// Made with Blockbench 4.9.3
...
public class WightModel<T extends Entity> extends HierarchicalModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "wight"), "main");
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.animate(((WightEntity) entity).emerginState, ModAnimationDefinitions.WIGHT_EMERGING, ageInTicks, 1f);
